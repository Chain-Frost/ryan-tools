...
| --- | --- | --- | --- | --- | --- |
| [Floodway design and reporting workflow](2026-09-13-floodway-design-87.md) | Active | Unassigned | 2026-09-13 | 2026-09-27 or after PR #86 merges | Continue source research; after PR #86 merges refresh the branch from fresh `main` before substantial implementation. |
