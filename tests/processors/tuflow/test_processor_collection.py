...
class TestProcessorCollection:
    ...
    def test_combine_1d_timeseries_missing_keys(self):
        ...
        p1.dataformat = "Timeseries"
        # Missing 'Time'
        p1.df = pd.DataFrame({"internalName": ["Run1"], "Chan ID": ["C1"], "Val": [10]})
    ...
    def test_combine_1d_timeseries_with_eof_and_hwd(self):
        ...
        p_eof.df = pd.DataFrame({"Chan ID": ["C1"], "US Invert": [10.0], "Height": [2.0]})
    ...
    def test_combine_1d_maximums_with_eof(self):
        ...
        p_eof.dataformat = "EOF"
        p_eof.name_parser.raw_run_code = "Run1"
        p_eof.df = pd.DataFrame({"Chan ID": ["C1"], "Area_Culv": [5.0]})
    ...
    def test_combine_1d_maximums_missing_keys(self):
        ...
        p1.df = pd.DataFrame({"Chan ID": ["C1"], "Q": [100]})
    ...
    def test_combine_1d_maximums_eof_only(self):
        ...
        p_eof.dataformat = "EOF"
        p_eof.name_parser.raw_run_code = "Run1"
        p_eof.df = pd.DataFrame({"internalName": ["Run1"], "Chan ID": ["C1"], "Area_Culv": [5.0]})
    ...
    def test_calculate_hw_d_ratio_edge_cases(self):
        ...
        df_invalid = pd.DataFrame({"US_h": [10], "US Invert": [5], "Height": [0], "Chan ID": ["C1"]})
