...
def test_smoke_process_all_files(tuflow_test_data: Path) -> None:
    ...
    KNOWN_PROBLEMATIC_FILES = {
        "EG02_012_PO.csv", "EG02_013_PO.csv", "EG02_014_PO.csv",
        "EG08_010_1d_ccA_L.dbf", "EG08_011_1d_ccA_L.dbf", "EG08_012_1d_ccA_L.dbf", "EG08_013_1d_ccA_L.dbf",
        "EG11_005_1d_ccA_L.dbf", "EG11_006_1d_ccA_L.dbf", "EG11_006_1d_Nmx.csv",
        # H files missing _US/_DS suffixes
        "EG15_000_1d_H.csv", "EG15_001_1d_H.csv", "EG15_002_1d_H.csv", "EG15_003_1d_H.csv",
        "EG15_004_1d_H.csv", "EG15_005_1d_H.csv", "EG15_006_1d_H.csv", "EG15_007_1d_H.csv",
        "EG15_008_1d_H.csv", "EG15_009_1d_H.csv", "EG15_010_1d_H.csv",
        "EG14_001_1d_H.csv", "EG14_002_1d_H.csv", "EG14_003_1d_H.csv",
        "EG12_001_1d_H.csv", "EG12_002_1d_H.csv", "EG12_003_1d_H.csv", "EG12_004_1d_H.csv",
        "EG12_005_1d_H.csv", "EG12_006_1d_H.csv", "EG12_007_1d_H.csv", "EG12_008_1d_H.csv",
        "EG12_009_1d_H.csv", "EG12_010_1d_H.csv", "EG12_011_1d_H.csv", "EG12_012_1d_H.csv",
        "EG12_013_1d_H.csv",
        "EG11_001_1d_H.csv", "EG11_002_1d_H.csv", "EG11_003_1d_H.csv", "EG11_005_1d_H.csv",
        "EG11_006_1d_H.csv", "EG11_007_1d_H.csv", "EG11_008_1d_H.csv", "EG11_009_1d_H.csv",
        "EG11_010_1d_H.csv", "EG11_011_1d_H.csv", "EG11_012_1d_H.csv",
        "EG11_Q100_2hr_004_1d_H.csv", "EG11_QPMF_2hr_004_1d_H.csv",
        "EG08_010_1d_H.csv", "EG08_011_1d_H.csv", "EG08_012_1d_H.csv", "EG08_013_1d_H.csv",
        "EG04_004_1d_H.csv", "EG04_005_1d_H.csv", "EG04_006_1d_H.csv",
        "EG02_013_1d_H.csv", "EG02_014_1d_H.csv"
    }
    ...
    for file_path in files:
        try:
            ...
            if not processor.processed:
                ...
                warnings.append(f"{file_path.name}: Processor.processed is False (Size: {file_path.stat().st_size} bytes)")
                continue
