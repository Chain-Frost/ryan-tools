...
class TestPommMaxItems:
    @patch("ryan_library.scripts.pomm_max_items.aggregated_from_paths")
    @patch("ryan_library.scripts.pomm_max_items.setup_logger")
    ...
    @patch("ryan_library.scripts.pomm_max_items.aggregated_from_paths")
    @patch("ryan_library.scripts.pomm_max_items.logger")
    ...
    @patch("ryan_library.scripts.pomm_max_items.run_peak_report_workflow")
    def test_export_median_peak_report(self, mock_workflow):
        """Test export_median_peak_report wrapper."""
        pomm_max_items.export_median_peak_report(
            script_directory=Path("."),
            log_level="DEBUG"
        )
    ...
    def test_export_mean_peak_report(self, mock_workflow):
        ...
        pomm_max_items.export_mean_peak_report(
            script_directory=Path("."),
            log_level="DEBUG"
        )
    ...
    @patch("ryan_library.scripts.pomm_max_items.export_median_peak_report")
    ...
    @patch("ryan_library.scripts.pomm_max_items.export_mean_peak_report")
