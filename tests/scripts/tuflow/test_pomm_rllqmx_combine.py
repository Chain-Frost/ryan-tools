...
@patch("ryan_library.orchestrators.tuflow.pomm_combine.collect_files")
@patch("ryan_library.orchestrators.tuflow.pomm_combine.process_files_in_parallel")
@patch("ryan_library.orchestrators.tuflow.pomm_combine.export_results")
