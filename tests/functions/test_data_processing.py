...
class TestCheckFunctions(unittest.TestCase):
    def test_check_string_TP_valid(self):
        # Valid cases
        assert check_string_TP("TP01_somefile.csv") == "01"
        assert check_string_TP("example_TP12.csv") == "12"
        assert check_string_TP("_TP99+file.csv") == "99"
        assert check_string_TP("TP1_valid.csv") == "1"  # 1 digit is valid
    ...
    def test_check_string_duration_valid(self):
        # Valid cases
        assert check_string_duration("somefile_00360m.csv") == "00360"
        assert check_string_duration("example+00900m.csv") == "00900"
        assert check_string_duration("_010m+file.csv") == "010"
    ...
    def test_check_string_aep_valid(self):
        # Valid cases
        assert check_string_aep("example_01.00p_file.csv") == "01.00"
        assert check_string_aep("+05.50p_file.csv") == "05.50"
        assert check_string_aep("03.5p_+example.csv") == "03.5"
