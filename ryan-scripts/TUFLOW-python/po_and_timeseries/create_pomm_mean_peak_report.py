...
Examples:
    python create_pomm_mean_peak_report.py --no-pause
    python create_pomm_mean_peak_report.py --working-directory E:\TUFLOW\Results --locations PO_01 PO_02
"""
...
def _parse_cli_arguments() -> CommonWrapperOptions:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=r"""Example:
  python create_pomm_mean_peak_report.py --working-directory E:\TUFLOW\Results --locations PO_01 PO_02 --no-pause""",
